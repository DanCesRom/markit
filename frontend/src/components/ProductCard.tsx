...
function altMarketName(o: AltOffer) {
...
export default function ProductResultCard(props: {
  ...
  async function addToCart(supermarket_product_id: number) {
    try {
      setErr(null);
      setAddingId(supermarket_product_id);
      ...
      // UX tipo Uber Eats → te manda directo al carrito
      navigate("/cart");
    } catch (e: any) {
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                disabled={
                  ...
                  addingId === best?.supermarket_product_id
                }
                onClick={() =>
                  best?.supermarket_product_id &&
                  addToCart(best.supermarket_product_id)
                }
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="text-xs font-semibold">
                      RD$ {(o.price ?? 0).toFixed(2)}
                    </div>
                    <button
                      disabled={!spid || addingId === spid}
