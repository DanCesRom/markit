...
function StoreCard(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={`grid h-20 place-items-center overflow-hidden rounded-2xl ${
          props.bgColor ?? "bg-zinc-100"
        }`}
      >
        <img
          src={s.logoSrc}
...
function HomeSearchBar() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="grid h-12 w-12 place-items-center rounded-2xl border border-zinc-200 bg-white shadow-sm"
        aria-label="search"
        title="Search"
      >
...
function getAddressButtonText(address: Address | null) {
  if (!address) return "Choose address";
  ...
  return shortAddress || label || "Choose address";
}
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div className="leading-tight">
              <div className="text-sm font-semibold text-zinc-600">Hi Sofia</div>
