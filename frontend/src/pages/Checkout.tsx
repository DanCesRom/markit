                ...
                <div className="rounded-2xl bg-white">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-3">
                        <button
                            ...
                            className={`rounded-2xl border px-4 py-4 text-left transition ${effectiveDeliveryType === "pickup"
                        ...
                        >
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <span
                                    className={`grid h-5 w-5 place-items-center rounded-full border ${effectiveDeliveryType === "pickup"
                        ...
                        <button
                            ...
                            className={`rounded-2xl border px-4 py-4 text-left transition ${effectiveDeliveryType === "delivery"
                                    ? "border-emerald-700 bg-emerald-50/40"
                                    : "border-zinc-200 bg-white"
                                } hover:bg-zinc-50`}
                        >
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <span
                                    className={`grid h-5 w-5 place-items-center rounded-full border ${effectiveDeliveryType === "delivery"
                                            ? "border-emerald-700 bg-emerald-700 text-white"
                                            : "border-zinc-300 bg-white"
                                        }`}
                                >
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-3 overflow-hidden rounded-2xl border border-zinc-200 bg-white">
                        <button
                            ...
                            className={`flex w-full items-center justify-between px-4 py-4 text-left ${effectiveDeliveryType === "delivery" || isMultiSupermarket
                                    ? "opacity-50"
                                    : "hover:bg-zinc-50"
                                }`}
                        >
                            ...
                            <span
                                className={`grid h-5 w-5 place-items-center rounded-full border ${effectivePayType === "cash"
                                        ? "border-emerald-700 bg-emerald-700 text-white"
                                        : "border-zinc-300 bg-white"
                                    }`}
                            >
                        ...
                        >
                            ...
                            <span
                                className={`grid h-5 w-5 place-items-center rounded-full border ${effectivePayType === "card"
                                        ? "border-emerald-700 bg-emerald-700 text-white"
                                        : "border-zinc-300 bg-white"
                                    }`}
                            >
                                    ...
                                    <div className="space-y-2">
                                        {methods.map((m) => (
                                            <button
                                                ...
                                                className={`flex w-full items-center justify-between rounded-2xl border bg-white px-3 py-3 text-left ${selectedCardId === m.id ? "border-emerald-700" : "border-zinc-200"
                                                    }`}
                                            >
                                                <div className="text-sm font-semibold">
                                                ...
                                                <span
                                                    className={`grid h-5 w-5 place-items-center rounded-full border ${selectedCardId === m.id
                                                            ? "border-emerald-700 bg-emerald-700 text-white"
                                                            : "border-zinc-300 bg-white"
                                                        }`}
                                                >
                                    ...
                                    {g.items.map((it) => (
                                        ...
                                        >
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <div className="text-xs text-zinc-550">Qty: {toNum(it.quantity)}</div>
                                            </div>
                                            <div className="font-semibold text-zinc-500">{money(it.line_total)}</div>
                                        </div>
                                    ))}
                                </div>
                            </div>
