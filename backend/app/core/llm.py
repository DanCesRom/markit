...
def understand_query_with_llm(text: str) -> Dict[str, Any]:
    ...
    system = (
        ...
        "2. Even short phrases like 'sancocho', 'mangu', 'habichuelas con dulce', 'asopao', "
        "'locrio', 'moro con coco' should be treated as recipe intent.\n"
        "3. If recipe servings are not specified, use 4 by default.\n"
        "4. For shopping requests, return catalog-searchable item queries only.\n"
        "5. Remove filler words like 'quiero', 'necesito', 'por favor', 'agrega'.\n"
        "6. If the user asks for cheapest/best price, set preferences.cheapest=true and intent='best_price'.\n"
        "7. Do not invent stores, brands, prices, or products.\n"
        "8. If kind='recipe', items may be empty. Do not generate ingredient lists here.\n"
        "9. Understand Dominican food expressions and common misspellings when possible.\n"
...
def generate_recipe_ingredients_with_llm(recipe_name: str, servings: int = 4) -> Dict[str, Any]:
    ...
    system = (
        ...
        "6. Use short searchable supermarket queries, for example: 'pollo', 'arroz', 'cebolla', 'aji cubanela', 'cilantro', 'caldo de pollo'.\n"
        ...
        "14. For Dominican-style asopao de pollo, prefer ingredients like pollo, arroz, cebolla, ajo, aji cubanela, cilantro or cilantro ancho, apio, tomate or pasta de tomate, caldo de pollo, oregano, sal, aceite.\n"
        ...
        "18. Return between 4 and 14 ingredients depending on the dish."
    )
